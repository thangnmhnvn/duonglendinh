var GameConfig = {
    ...
    paths: {
        ...
        vdIntro: "media/media28.mp4", // <-- THÊM MỚI: Intro vòng 4
        audio: {
            ...
            showQuestion: "media/media23.mp3",
            correct: "media/media39.wav",
            inCorrect: "media/audio6.wav",
            endGame: "media/media36.mp3",
        }
    },

    // Danh sách 4 thí sinh
    players: [
        { id: 1, name: "Máu Đỏ Da Vàng", school: "THPT Chuyên Hà Nội", avatar: "images/player1.jpg", score: 0 },
        { id: 2, name: "Đoàn Kết Là Never Chết", school: "THPT Lê Quý Đôn", avatar: "images/player2.jpg", score: 0 },
        { id: 3, name: "Biệt Đội Lầy Lội", school: "THPT Năng Khiếu", avatar: "images/player3.jpg", score: 0 },
        { id: 4, name: "Mệt Mỏi Vì Học Giỏi", school: "THPT Quốc Học", avatar: "images/player4.jpg", score: 0 }
    ],
...
Object.assign(GameConfig.rounds, {
    khoiDong: {
        duration: 60,        // 60 giây
